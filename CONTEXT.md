...
- Toast exposes one global callable facade over Base UI's manager. Base UI owns the queue, timers, focus, transitions, and Promise races; Compose owns stable title/status/action semantics. See [ADR-0013](docs/adr/0013-toast-base-ui-manager-facade.md).
