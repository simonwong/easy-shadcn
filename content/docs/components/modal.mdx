...
| `confirmProps` / `cancelProps` | `Omit<AsyncButtonProps, "children" \| "onClick">` | - | Extra props for the default footer buttons (e.g. `{ variant: "destructive" }`). AsyncButton-owned element/semantic keys are excluded too. |
