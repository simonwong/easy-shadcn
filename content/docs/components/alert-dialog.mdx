...
| `confirmProps` / `cancelProps` | `Omit<AsyncButtonProps, "children" \| "onClick">` | - | Extra props for the footer buttons. Button elements/semantics, labels, and click handlers are owned; typed and JavaScript / `any` callers cannot replace the action or close wiring. |
